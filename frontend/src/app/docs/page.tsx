      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        <ul className="space-y-6 text-lg">
          ...
          <li className="p-6 bg-gray-900 rounded-xl shadow-md">
            ...
            To use Polish PR, make sure you have a repository with at least <span className="text-orange-400">one open Pull Request</span> in your GitHub account. This is required for the agent to analyze your code and provide AI-powered review.
          </li>
        </ul>
      </main>
    </div>
